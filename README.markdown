...
- **`CardView`**: "cardview layout declaration"
- **`CoordinatorWithTabs`**: "CoordinatorLayout + AppBarLayout + TabLayout"
- **`CoordinatorWithToolbar`**: "CoordinatorLayout + AppBarLayout + Toolbar"
- **`FrameLayout`**: "FrameLayout declaration"
- **`lh`**: "android:layout_height=&quot;&quot;"
- **`lhm`**: "android:layout_height=&quot;match_parent&quot;"
- **`lhw`**: "android:layout_height=&quot;wrap_content&quot;"
- **`LinearLayout`**: "LinearLayout declaration"
...
- **`RelativeLayout`**: "RelativeLayout declaration"
...
- **`TextView`**: "TextView xml declaration"
